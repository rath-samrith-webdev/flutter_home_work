          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView(
                ...
                padding: EdgeInsets.symmetric(horizontal: 16),
                children: [
                  _buildCategoryItem("Mountains", Icons.landscape, Colors.teal),
                  _buildCategoryItem("Beach", Icons.beach_access, Colors.cyan),
                  _buildCategoryItem("Lakes", Icons.water, Colors.blue),
                  _buildCategoryItem("Forest", Icons.forest, Colors.green),
                ],
              ),
            ),
            ...
            SizedBox(
              ...
              child: ListView(
                ...
                padding: EdgeInsets.symmetric(horizontal: 16),
                children: [
                  _buildServiceItem("Resorts", Icons.apartment, true),
                  _buildServiceItem("Flights", Icons.flight_takeoff, false),
                  _buildServiceItem("Cruises", Icons.directions_boat, false),
                  _buildServiceItem("Expedition", Icons.explore, false),
                ],
              ),
            ),
